...
Door de gebruiker uitgesteld ("misschien op een ander moment"), niet vergeten:

- **Progressieregels** — bij alle reps gehaald automatisch gewichtsverhoging voorstellen. Later.
- **Weekprogramma's / mesocycli** — relevant zodra klanten 2×/week komen. Later.
- **Schema-sjablonen** — één schema aan meerdere klanten toewijzen. Later.

Bewust afgewezen (niet meer voorstellen):
